...
public class NgTemplateTest {

	@Test
	public void testConstructorStrings() {
		NgTemplate template = new NgTemplate("<h1>moin</h1>", "NgTemplateTest") {
	...
	public void testConstructorPackage() throws UnsupportedEncodingException,
		...
		NgTemplate template = new NgTemplate(NgTemplateTest.class.getPackage(),
				"NgTemplateTest") {
